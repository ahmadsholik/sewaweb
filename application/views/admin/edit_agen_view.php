...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
        <form data-parsley-validate action="<?php echo base_url('data_agen/simpan_edit')?>" method="post" enctype="multipart/form-data">
          <div class="col-sm-6">
            <div class="form-group">
              <label>Nama Agen</label>
              <input class="form-control" type="hidden" name="id_agen" value="<?php echo (!empty($agen[0]->id_agen)) ? $agen[0]->id_agen : ''?>" >
              ...
              <select class="form-control" name="kategori" required>
                ...
                <?php foreach ($kategori as $key => $k):
                  ...
                  if ($kid == $k->kategori_id) {
                    ...
                    echo '<option value="'.$k->kategori.'">'.$k->nama_kategori.'</option>';
                  }
                 endforeach; ?>
              </select>
            </div>
            <div class="form-group">
             ...
             <textarea class="form-control" type="text" name="keterangan" required><?php echo (!empty($agen[0]->keterangan)) ? $agen[0]->keterangan : ''?></textarea>
            </div>
            <div class="form-group">
              <label>No. Telp</label>
            ...
            <div class="form-group">
              <label>Alamat</label>
             <textarea class="form-control" type="text" name="alamat" required><?php echo (!empty($agen[0]->alamat)) ? $agen[0]->alamat : ''?></textarea>
            </div>
            <div class="form-group">
              <label>Kota</label>
